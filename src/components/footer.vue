...
<template>
  ...
  <div class="footBack footBackQian">
    <div class="footer-img"
         :style="{background:this.$store.state.bottomImg?'url('+this.$store.state.bottomImg+') no-repeat 50%':'url(static/img/footer01.png) no-repeat 50%'}">
    </div>
    <div class="fcontainer">
      <p>博客已萌萌哒运行
        <span v-html='longTime'>{{longTime}}</span><span class="timeJump">(●'◡'●)ﾉ♥</span>
      </p>
      <p>托管于
        <a href="https://github.com/HhjWxx" target="_blank">GitHub</a>.
        <a
          href="https://www.aliyun.com/?accounttraceid=2b30b46a-dab9-4099-9800-3f3c74ed04fb&source=5176.11533457&userCode=fzfxtn3t&type=copy"
          target="_blank">阿里云</a> 提供静态文件云存储服务.
        <a href="https://tongji.baidu.com/web/welcome/login" target="_blank">百度统计</a> 提供网站统计服务.
        <a
          href="https://www.aliyun.com/?accounttraceid=2b30b46a-dab9-4099-9800-3f3c74ed04fb&source=5176.11533457&userCode=fzfxtn3t&type=copy"
          target="_blank">阿里云</a> 提供 DNS 解析服务.
      </p>
      <p>由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. Theme By
        <a href="http://www.mangoya.cn" target="_blank">Mango Ya</a>. 粤ICP备19070427号
      </p>
      <p><span>Made with</span>
        <img class="fheart" src="static/img/heart02.png"/> <span>by noSum.</span>
      </p>
    </div>
  </div>
</template>
    ...
    export default {
        ...
        methods: { //事件处理器
            runTime: function () {//运行倒计时
                let that = this;
                let oldTime = new Date('2019/12/05 00:00:00');
